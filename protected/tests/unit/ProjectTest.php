...
class ProjectTest extends CDbTestCase {
    ...
    /**
     * Method for testing all CRUD operations against the Project AR class.
     */
    public function testCRUD() {
        ...
        $this->assertEquals($newProject->name, $retrievedProject->name);
    ...
    public function testCreate() {
        ...
        //the same as the applicaiton user we set when saving the project
        $this->assertEquals(Yii::app()->user->id, $retrievedProject->create_user_id);
    }

    public function testRead() {
        //test read project named : Test Project 1
